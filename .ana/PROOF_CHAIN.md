...
96 runs · 160 active · 117 lessons · 0 promoted · 312 closed

## Hot Modules

| File | Active | Entries |
|------|--------|--------|
| packages/cli/src/commands/work.ts | 16 | 9 |
...
| packages/cli/src/utils/worktree.ts | 8 | 5 |

## Promoted Rules

*No promoted rules yet.*

## Active Findings (30 shown of 160 total)
