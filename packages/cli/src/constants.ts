...
/** The 7 context files generated by `ana setup` (bare filenames) */
export const SETUP_CONTEXT_FILES = [
  'project-overview.md',
  'conventions.md',
  'patterns.md',
  'architecture.md',
...
/** Context files required for setup complete validation (with context/ prefix) */
