...
initialPrompt: "If .ana/ana.json exists and setupMode is 'not_started', show one notice: 'ℹ️ Setup hasn\\'t run yet. Ana is working from scan data only. For better results: claude --agent ana-setup (~10 min)'"
---
...
**Context files:** `.ana/context/*.md` (generated by scan, enriched by setup)
