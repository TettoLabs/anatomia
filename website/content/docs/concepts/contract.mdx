---
title: The contract
description: A contract is the seal between Plan and Build. It defines "done" as a list of assertions with matchers — mechanical, testable, unambiguous. Once sealed, it can't be changed.
readingTime: 7
