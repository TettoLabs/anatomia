...
## What you own, what the machine owns
...
## All 8 skills {/* Dynamic: update on data change */}
...
15 pre-curated gotchas ship with Anatomia. Each matches when all trigger conditions are satisfied — compound triggers prevent irrelevant advice. {/* Dynamic: update on data change */}
