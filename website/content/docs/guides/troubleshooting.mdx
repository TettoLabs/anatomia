...
3. Node 20+ required (`node --version`) — declared in `package.json` but not checked at runtime, so older versions produce cryptic errors
...
FAIL means Verify found issues — this is the pipeline working as designed. 17 of our 78 proofs had rejection cycles. {/* Dynamic: update on data change */}
...
<NextCards cards={[
  ...
  },
  {
    ...
    title: "Proof chain",
    href: "/docs/proof",
    description: "78 verified pipeline runs."
  }
]} />
