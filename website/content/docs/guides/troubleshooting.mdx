...
1. Check the detected command: `ana config show` — look at `commands.test`
2. In monorepos, init may target the wrong package or produce an invalid invocation
3. Override: `ana config set commands.test "your-command"`
